    ...
    template(id, model, data, text, subText, value=text, onClickAction=null){
        ...
        <div x-data="{
            ...
            <div class="relative mt-1" >
                <input @input.debounce.1000ms="${id}_show = !${id}_show" x-model="${model}" type="text" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md border-1" role="combobox" aria-controls="options" aria-expanded="false" autocomplete="off">
