...
BEGIN
  SET NOCOUNT ON
	SELECT 
		...
		[CACA].[Id] AS [ActivityContributionAreaId],
		[CAR].[Id] AS [PrimaryContributionAreaId],
		[CAR].[Name] AS [PrimaryContributionAreaName],
		[CAR].[Created] AS [PrimaryContributionCreated],
		[CAR].[CreatedBy] AS [PrimaryContributionCreatedBy],
		[CAR].[Modified] AS [PrimaryContributionModified],
		[CAR].[ModifiedBy] AS [PrimaryContributionModifiedBy],
		[C].[Url],
		[Date],
		[CA].[Created],
		[CA].[CreatedBy],
